...
const handleDrawCreated = useCallback(
    (event: L.LeafletEvent) => {
        ...
        // type narrowing
        const drawEvent = event as DrawEvents.Created

        featureGroupRef.current.addLayer(drawEvent.layer)
...
function MapDrawShapeButton<T extends Draw.Feature>({
    ...
    }, [L, map, isActive, createDrawTool, controlRef]);
    ...
    useEffect(() => {
        ...
        async function loadLeaflet() {
            ...
            if (!LeafletDraw) {
                ...
                if (mounted) setLeafletDraw(leafletDraw)
            }
        }
